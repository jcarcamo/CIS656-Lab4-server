  ...
  public Restlet createInboundRoot() {
		...
		Restlet mainpage = new Restlet() {
			...
			public void handle(Request request, Response response) {
				...
				stringBuilder
				.append("<head><title>Lab4 - Server Users</title></head>");
				stringBuilder.append("<body bgcolor=white>");
				stringBuilder.append("<h1>Chat Server RESTful web services</h1>");
				stringBuilder.append("Click <a href=\"/v1/users\">here</a> to see all connected users.");
